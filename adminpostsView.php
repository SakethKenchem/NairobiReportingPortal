...
<body>
    ...
    <div class="container mt-5">
        ...
        <b>
            <p class="mb-4" style="font-size: large;">Search for a Post by Post ID:</p>
        </b>
            ...
            <tbody>
                ...
                <?php while ($row = $result->fetch_assoc()) : ?>
                    <tr>
                        ...
                        <td>
                            <form method="post" action="adminpostsView.php" onsubmit="return confirm('Are you sure you want to delete this post?');">
